...
import { cn } from "../../components/ui/utils"; // Adjusted path to utils

interface AnimatedGradientBackgroundProps {
    className?: string; // Corrected interface name usage
...
export function BeamsBackground({
    ...
    return (
        <div
            className={cn(
                "relative flex w-full overflow-hidden bg-neutral-950",
                className
            )}
        >
            <canvas
